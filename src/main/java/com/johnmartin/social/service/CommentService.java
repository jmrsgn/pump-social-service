...
public class CommentService {
    ...
    public CommentResponse createComment(String postId, CreateCommentRequest request) {
        ...
        createdComment.setAuthor(user.getFirstName() + " " + user.getLastName());
        ...
        return CommentMapper.toResponse(commentToBeReturned, user.getId());
    }
    ...
    public CommentResponse likeComment(String postId, String commentId) {
        ...
        return CommentMapper.toResponse(updatedComment, user.getId());
    }
